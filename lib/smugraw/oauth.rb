...
module SmugRaw
  class OAuthClient
    ...
    def post_multipart(url, token_secret, oauth_params = {}, params = {})
      post(url, token_secret, oauth_params, params, true) {|request|
        boundary = "SmugRaw#{OAuthClient.gen_nonce}"
    ...
    def post(url, token_secret, oauth_params, params, multipart=false)
      url = URI.parse(url)
      ...
      params_signed = multipart ? oauth_params : params.reject {|k,v| v.respond_to? :read}.merge(oauth_params)
      ...
      #http.set_debug_output $stderr # NOTE: for oauth problems
